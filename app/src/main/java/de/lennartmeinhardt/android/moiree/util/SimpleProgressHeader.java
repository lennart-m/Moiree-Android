...
public class SimpleProgressHeader extends LinearLayout {

    private final TextView titleView;
    private final ProgressBar busyIndicator;


    public SimpleProgressHeader(Context context) {
        this(context, null);
    }

    public SimpleProgressHeader(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SimpleProgressHeader(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        inflate(context, R.layout.header_with_progress, this);
