...
public class HorizontalLinesImageSetupFragment extends BaseImageCreatorSetupFragment<HorizontalLinesImageCreator> implements Expandable {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        binding.setHorizontalLinesImageCreator(getImageCreator());
    ...
    @Override
    protected HorizontalLinesImageCreator initializeImageCreator() {
        int defLineThickness = getResources().getDimensionPixelSize(R.dimen.horizontal_lines_image_default_line_thickness);
        HorizontalLinesImageCreator imageCreator = new HorizontalLinesImageCreator(defLineThickness);
